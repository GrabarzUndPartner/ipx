...
const http__default$1 = /*#__PURE__*/_interopDefaultLegacy(http$1);
const https__default$1 = /*#__PURE__*/_interopDefaultLegacy(https$1);
...
static [h$1](o) {return o&&typeof o==='object'&&o[t]==='FormData'&&!m.some(m=>typeof o[m]!='function')}
...
const createHTTPSource = (options) => {
  const httpsAgent = new https__default$1.Agent({ keepAlive: true });
  const httpAgent = new http__default$1.Agent({ keepAlive: true });
