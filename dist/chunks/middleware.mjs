...
const createHTTPSource = (options) => {
  const httpsAgent = new https$1.Agent({ keepAlive: true });
  const httpAgent = new http$1.Agent({ keepAlive: true });
...
export { FormData as F, createIPXMiddleware as a, File as b, createIPX as c, handleRequest as h };
